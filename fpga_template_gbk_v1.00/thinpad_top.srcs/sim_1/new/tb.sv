...
//parameter BASE_RAM_INIT_FILE = "D:\\MY-PROJECTS\\NSCC\\nscscc2020\\supervisor_v2.01\\kernel\\kernel.bin"; //BaseRAM初始化文件，请修改为实际的绝对路径
//parameter EXT_RAM_INIT_FILE = "D:\\MY-PROJECTS\\NSCC\\nscscc2020\\supervisor_v2.01\\kernel\\kernel.bin";   //ExtRAM初始化文件，请修改为实际的绝对路径
//parameter FLASH_INIT_FILE = "D:\\MY-PROJECTS\\NSCC\\nscscc2020\\supervisor_v2.01\\kernel\\kernel.elf";    //Flash初始化文件，请修改为实际的绝对路径
...
parameter OP_A_num=32'd4;//8byte ==> 写2条inst
